...
.. code-block:: python
    ...
    from raucle.integrations.autogen import (
        gated_tools,
        set_in_force_token,
        CapabilityDenied,
    )
...
Install with ``pip install 'raucle[autogen]'``.
"""
...
def gated_tools(
    ...
    *,
    ...
    if not _HAS_AUTOGEN:
        raise RuntimeError(
            "gated_tools requires autogen-core. Install with: pip install 'raucle[autogen]'"
        )
