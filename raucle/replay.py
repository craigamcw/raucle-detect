...
Given a chain produced by :mod:`raucle.provenance` and an input store
...
- :class:`Replayer` — given a :class:`~raucle.scanner.Scanner` and an
...
The CLI surfaces this as ``raucle provenance replay``.
