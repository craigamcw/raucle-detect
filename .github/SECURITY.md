...
If you discover a security vulnerability in Raucle, **do not open a public issue**.
...
- Deliberately crafted adversarial inputs (prompt injection is the threat model, not a vulnerability in Raucle)
