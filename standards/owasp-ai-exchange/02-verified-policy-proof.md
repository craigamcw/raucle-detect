...
Apache-2.0 Python implementation in `raucle/prove.py`. ~530 lines. Uses Z3 via `z3-solver`. Lean 4 mechanisation of the policy-proof composition theorem (Theorem 3 in the accompanying paper) lives in `paper/lean/VCD/Composition.lean`.
