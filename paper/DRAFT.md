...
The reference implementation, Lean development, and benchmark harness are released as open source under a permissive licence (Apache-2.0) and available at `[anonymised]`.
