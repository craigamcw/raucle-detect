...
raucle is licensed under the **Apache License, Version 2.0**
...
redistribute raucle — including inside closed-source products and hosted
...
- **Code.** The engine in `raucle/` is Apache-2.0. The five reference
...
- **Patents.** Apache-2.0 §3 includes an explicit patent grant from
  ...
  assurance for adopters building on raucle as a standard.
...
raucle aims to be the de-facto reference for verifiable agent
